...
struct SplashScreenView: View {
    ...
    var features: [SplashscreenFeature] = [
        SplashscreenFeature(withImage: "features", title: "Keep track of everything", description: "Keep track of everything"),
        SplashscreenFeature(withImage: "work-group", title: "All in a single place", description: "Save your marks, reminders and exams all in this app"),
        SplashscreenFeature(withImage: "work-time", title: "Extremely simple to use", description: "Designed with ease of use in mind to get you back to work as soon as possible")
    ]
